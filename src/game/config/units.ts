...
export const UNIT_CONFIG: Record<UnitType, UnitMetadata> = {
  ...
  unit2: { 
    ...
    bonus: 1.15,
    name: "Tutorial Tim", 
    emoji: "/Icon_for_Tutorial_Tim__a_young.png", 
    color: "#8B7355",
    bonusColor: "#FFD600",
  ...
  unit3: { 
    ...
    emoji: "/Sigma_male_coach__online_sport.png", 
    color: "#7CB342",
    bonusColor: "#FF9100",
  ...
  unit4: { 
    ...
    emoji: "/ClickBait_Karen__angry_woman_m.png", 
    color: "#78909C",
    bonusColor: "#00B8D4",
  ...
  unit6: { 
    ...
    bonus: 1.3,
    name: "Cat meme", 
    emoji: "/pixel_art_Cat_meme_icon.png", 
    color: "#5C6BC0",
    bonusColor: "#00BFAE",
  ...
  unit7: { 
    ...
    emoji: "/pixel_art_icon_of_troll_with_h.png", 
    color: "#8E24AA",
    bonusColor: "#D500F9",
  ...
  unit8: { 
    ...
    emoji: "/pixel_art_game_controller_icon.png", 
    color: "#5E35B1",
    bonusColor: "#651FFF",
